...
@p_str7 = private unnamed_addr constant [6 x i8] c"loop6\00", align 1
@p_str6 = private unnamed_addr constant [6 x i8] c"loop5\00", align 1
@p_str5 = private unnamed_addr constant [6 x i8] c"loop4\00", align 1
@p_str4 = private unnamed_addr constant [6 x i8] c"loop3\00", align 1
@p_str3 = private unnamed_addr constant [6 x i8] c"loop2\00", align 1
@p_str2 = private unnamed_addr constant [6 x i8] c"loop1\00", align 1
@p_str1 = private unnamed_addr constant [12 x i8] c"ROM_nP_BRAM\00", align 1
...
; <label>:5                                       ; preds = %6, %4
  ...
  %t_8 = add i5 %t_2, 1
  br i1 %exitcond3, label %.preheader7.preheader, label %6
...
; <label>:6                                       ; preds = %5
  ...
  %tmp5 = add i32 %K_load, %W_load_4
  %tmp7 = add i32 %E1, %tmp_24
  %tmp6 = add i32 %tmp7, %tmp_72_i1
...
.preheader7:                                      ; preds = %7, %.preheader7.preheader
  %E_s = phi i32 [ %E1, %.preheader7.preheader ], [ %E_4, %7 ]
  %E_4 = phi i32 [ %E_1, %.preheader7.preheader ], [ %D_2, %7 ]
  %D_2 = phi i32 [ %D_1, %.preheader7.preheader ], [ %C_2, %7 ]
  %B_read_assign_1 = phi i32 [ %B_read_assign, %.preheader7.preheader ], [ %B_2, %7 ]
  %B_2 = phi i32 [ %B_1, %.preheader7.preheader ], [ %temp_1, %7 ]
  %t_3 = phi i6 [ 20, %.preheader7.preheader ], [ %t_9, %7 ]
  %exitcond2 = icmp eq i6 %t_3, -24
  %empty_34 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 20, i64 20, i64 20)
  br i1 %exitcond2, label %.preheader6.preheader, label %7
...
; <label>:7                                       ; preds = %.preheader7
  ...
  %tmp9 = add i32 %K_load_1, %W_load_5
  %tmp11 = add i32 %tmp_28, %E_s
  %tmp10 = add i32 %tmp11, %tmp_72_i2
...
.preheader6:                                      ; preds = %8, %.preheader6.preheader
  %E_2 = phi i32 [ %E_s, %.preheader6.preheader ], [ %E_5, %8 ]
  %E_5 = phi i32 [ %E_4, %.preheader6.preheader ], [ %D_3, %8 ]
  %D_3 = phi i32 [ %D_2, %.preheader6.preheader ], [ %C_3, %8 ]
  %B_read_assign_2 = phi i32 [ %B_read_assign_1, %.preheader6.preheader ], [ %B_3, %8 ]
  %B_3 = phi i32 [ %B_2, %.preheader6.preheader ], [ %temp_2, %8 ]
  %t_4 = phi i6 [ -24, %.preheader6.preheader ], [ %t_10, %8 ]
  %exitcond1 = icmp eq i6 %t_4, -4
  %empty_35 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 20, i64 20, i64 20)
  br i1 %exitcond1, label %.preheader.preheader, label %8
...
; <label>:8                                       ; preds = %.preheader6
  ...
  %tmp12 = add i32 %K_load_2, %W_load_6
  %tmp14 = add i32 %E_2, %tmp_33
  %tmp13 = add i32 %tmp14, %tmp_72_i3
...
.preheader:                                       ; preds = %9, %.preheader.preheader
  %E_3 = phi i32 [ %E_2, %.preheader.preheader ], [ %E_6, %9 ]
  %E_6 = phi i32 [ %E_5, %.preheader.preheader ], [ %D_4, %9 ]
  %D_4 = phi i32 [ %D_3, %.preheader.preheader ], [ %C_4, %9 ]
  %B_read_assign_3 = phi i32 [ %B_read_assign_2, %.preheader.preheader ], [ %B_4, %9 ]
  %B_4 = phi i32 [ %B_3, %.preheader.preheader ], [ %temp_3, %9 ]
  %t_5 = phi i7 [ 60, %.preheader.preheader ], [ %t_11, %9 ]
...
; <label>:9                                       ; preds = %.preheader
  ...
  %tmp16 = add i32 %K_load_3, %W_load_7
  %tmp18 = add i32 %tmp_40, %E_3
  %tmp17 = add i32 %tmp18, %tmp_72_i4
