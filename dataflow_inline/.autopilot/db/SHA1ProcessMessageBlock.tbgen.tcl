...
set portList { 
	...
	{ context_Message_Block_d0 sc_out sc_lv 8 signal 2 } 
	{ context_Message_Block_q0 sc_in sc_lv 8 signal 2 } 
	{ context_Message_Block_we0 sc_out sc_logic 1 signal 2 } 
	{ context_Message_Block_address1 sc_out sc_lv 6 signal 2 } 
	{ context_Message_Block_ce1 sc_out sc_logic 1 signal 2 } 
	{ context_Message_Block_d1 sc_out sc_lv 8 signal 2 } 
	{ context_Message_Block_q1 sc_in sc_lv 8 signal 2 } 
	{ context_Message_Block_we1 sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "context_Message_Block_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "context_Message_Block", "role": "d0" }} , 
 	...
 	{ "name": "context_Message_Block_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "context_Message_Block", "role": "we0" }} , 
 	...
 	{ "name": "context_Message_Block_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "context_Message_Block", "role": "d1" }} , 
 	...
 	{ "name": "context_Message_Block_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "context_Message_Block", "role": "we1" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"], "CDFG" : "SHA1ProcessMessageBlock", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "1", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "context_Intermediate_Hash", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : [
			{"SubInst" : "SHA1ProcessMessageBlock_Block_proc_U0", "Port" : "context_Intermediate_Hash"}]}, 
		{"Name" : "context_Message_Block_Index", "Type" : "Vld", "Direction" : "O", "BlockSignal" : [], "SubConnect" : [
			{"SubInst" : "SHA1ProcessMessageBlock_Block_proc_U0", "Port" : "context_Message_Block_Index"}]}, 
		{"Name" : "context_Message_Block", "Type" : "Memory", "Direction" : "I", "BlockSignal" : [], "SubConnect" : [
			{"SubInst" : "SHA1ProcessMessageBlock_Loop_loop1_proc_U0", "Port" : "context_Message_Block"}]}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.W_U", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.SHA1ProcessMessageBlock_Loop_loop1_proc_U0", "Parent" : "0", "Child" : [], "CDFG" : "SHA1ProcessMessageBlock_Loop_loop1_proc", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "context_Message_Block", "Type" : "Memory", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "W", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.SHA1ProcessMessageBlock_Block_proc_U0", "Parent" : "0", "Child" : [], "CDFG" : "SHA1ProcessMessageBlock_Block_proc", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "context_Intermediate_Hash", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}, 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "412", "Max" : "412"}
	, {"Name" : "Interval", "Min" : "243", "Max" : "243"}
]}

set Spec2ImplPortList { 
	context_Intermediate_Hash { ap_memory {  { context_Intermediate_Hash_address0 mem_address 1 3 }  { context_Intermediate_Hash_ce0 mem_ce 1 1 }  { context_Intermediate_Hash_d0 mem_din 1 32 }  { context_Intermediate_Hash_q0 mem_dout 0 32 }  { context_Intermediate_Hash_we0 mem_we 1 1 }  { context_Intermediate_Hash_address1 mem_address 1 3 }  { context_Intermediate_Hash_ce1 mem_ce 1 1 }  { context_Intermediate_Hash_d1 mem_din 1 32 }  { context_Intermediate_Hash_q1 mem_dout 0 32 }  { context_Intermediate_Hash_we1 mem_we 1 1 } } }
	...
	context_Message_Block { ap_memory {  { context_Message_Block_address0 mem_address 1 6 }  { context_Message_Block_ce0 mem_ce 1 1 }  { context_Message_Block_d0 mem_din 1 8 }  { context_Message_Block_q0 mem_dout 0 8 }  { context_Message_Block_we0 mem_we 1 1 }  { context_Message_Block_address1 mem_address 1 6 }  { context_Message_Block_ce1 mem_ce 1 1 }  { context_Message_Block_d1 mem_din 1 8 }  { context_Message_Block_q1 mem_dout 0 8 }  { context_Message_Block_we1 mem_we 1 1 } } }
}
