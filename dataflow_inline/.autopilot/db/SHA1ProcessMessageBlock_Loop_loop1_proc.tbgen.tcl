set moduleName SHA1ProcessMessageBlock_Loop_loop1_proc
...
set isOneStateSeq 0
set C_modelName {SHA1ProcessMessageBlock_Loop_loop1_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ context_Message_Block int 8 regular {array 64 { 1 1 } 1 1 }  }
	{ W int 32 regular {array 80 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "context_Message_Block", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ context_Message_Block_address0 sc_out sc_lv 6 signal 0 } 
	{ context_Message_Block_ce0 sc_out sc_logic 1 signal 0 } 
	{ context_Message_Block_q0 sc_in sc_lv 8 signal 0 } 
	{ context_Message_Block_address1 sc_out sc_lv 6 signal 0 } 
	{ context_Message_Block_ce1 sc_out sc_logic 1 signal 0 } 
	{ context_Message_Block_q1 sc_in sc_lv 8 signal 0 } 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "SHA1ProcessMessageBlock_Loop_loop1_proc", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set Spec2ImplPortList { 
	...
	W { ap_memory {  { W_address0 mem_address 1 7 }  { W_ce0 mem_ce 1 1 }  { W_we0 mem_we 1 1 }  { W_d0 mem_din 1 32 }  { W_q0 mem_dout 0 32 }  { W_address1 mem_address 1 7 }  { W_ce1 mem_ce 1 1 }  { W_we1 mem_we 1 1 }  { W_d1 mem_din 1 32 }  { W_q1 mem_dout 0 32 } } }
}
