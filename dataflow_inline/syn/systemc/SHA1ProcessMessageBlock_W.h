...
#ifndef _SHA1ProcessMessageBlock_W_H_
#define _SHA1ProcessMessageBlock_W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "SHA1ProcessMessageBlock_W_memcore.h"

SC_MODULE(SHA1ProcessMessageBlock_W) {
...
protected:
    ...
    // buffer instances
    SHA1ProcessMessageBlock_W_memcore* buffer[BufferCount];
...
public:
    ...
    SC_CTOR(SHA1ProcessMessageBlock_W) : m_trace_file(0) {
        for (unsigned i = 0; i < BufferCount; i++) {
            char szTmp[128];
            sprintf(szTmp, "%d", i);
            std::string name = "SHA1ProcessMessageBlock_W_memcore_U_";
            name += szTmp;

            buffer[i] = new SHA1ProcessMessageBlock_W_memcore(name.c_str());
            buffer[i]->clk      ( clk );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "SHA1ProcessMessageBlock_W.trace");
            // ports
