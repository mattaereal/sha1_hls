; ModuleID = '/home/matt/workspace/sha1_hls/dataflow_inline_stream/.autopilot/db/a.o.3.bc'
...
; <label>:1                                       ; preds = %0
  ...
  %tmp_2_i = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %tmp, i2 0), !dbg !90 ; [#uses=4 type=i6] [debug line = 56:9]
  %tmp_3_i = zext i6 %tmp_2_i to i64, !dbg !90    ; [#uses=1 type=i64] [debug line = 56:9]
  %context_Message_Block_addr = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_3_i, !dbg !90 ; [#uses=1 type=i8*] [debug line = 56:9]
  %context_Message_Block_load = load i8* %context_Message_Block_addr, align 1, !dbg !90 ; [#uses=1 type=i8] [debug line = 56:9]
  %tmp_6_i = zext i5 %t_0_i_i to i64, !dbg !90    ; [#uses=1 type=i64] [debug line = 56:9]
  %W_addr = getelementptr inbounds [80 x i32]* %W, i64 0, i64 %tmp_6_i, !dbg !90 ; [#uses=1 type=i32*] [debug line = 56:9]
  %tmp_7_i = or i6 %tmp_2_i, 1, !dbg !91          ; [#uses=1 type=i6] [debug line = 57:9]
  %tmp_8_i = zext i6 %tmp_7_i to i64, !dbg !91    ; [#uses=1 type=i64] [debug line = 57:9]
  %context_Message_Block_addr_1 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_8_i, !dbg !91 ; [#uses=1 type=i8*] [debug line = 57:9]
  %context_Message_Block_load_1 = load i8* %context_Message_Block_addr_1, align 1, !dbg !91 ; [#uses=1 type=i8] [debug line = 57:9]
  %tmp_11_i = or i6 %tmp_2_i, 2, !dbg !92         ; [#uses=1 type=i6] [debug line = 58:9]
  %tmp_12_i = zext i6 %tmp_11_i to i64, !dbg !92  ; [#uses=1 type=i64] [debug line = 58:9]
  %context_Message_Block_addr_2 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_12_i, !dbg !92 ; [#uses=1 type=i8*] [debug line = 58:9]
  %context_Message_Block_load_2 = load i8* %context_Message_Block_addr_2, align 1, !dbg !92 ; [#uses=1 type=i8] [debug line = 58:9]
  %tmp_16_i = or i6 %tmp_2_i, 3, !dbg !93         ; [#uses=1 type=i6] [debug line = 59:9]
  %tmp_17_i = zext i6 %tmp_16_i to i64, !dbg !93  ; [#uses=1 type=i64] [debug line = 59:9]
  %context_Message_Block_addr_3 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_17_i, !dbg !93 ; [#uses=1 type=i8*] [debug line = 59:9]
  %context_Message_Block_load_3 = load i8* %context_Message_Block_addr_3, align 1, !dbg !93 ; [#uses=1 type=i8] [debug line = 59:9]
  %tmp_19_i = call i32 @_ssdm_op_BitConcatenate.i32.i8.i8.i8.i8(i8 %context_Message_Block_load, i8 %context_Message_Block_load_1, i8 %context_Message_Block_load_2, i8 %context_Message_Block_load_3), !dbg !93 ; [#uses=1 type=i32] [debug line = 59:9]
  store i32 %tmp_19_i, i32* %W_addr, align 4, !dbg !93 ; [debug line = 59:9]
