...
; <label>:1                                       ; preds = %0
  ...
  %tmp_2_i = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %tmp, i2 0)
  %tmp_3_i = zext i6 %tmp_2_i to i64
  %context_Message_Block_addr = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_3_i
  %context_Message_Block_load = load i8* %context_Message_Block_addr, align 1
  %tmp_6_i = zext i5 %t_0_i_i to i64
  %W_addr = getelementptr inbounds [80 x i32]* %W, i64 0, i64 %tmp_6_i
  %tmp_7_i = or i6 %tmp_2_i, 1
  %tmp_8_i = zext i6 %tmp_7_i to i64
  %context_Message_Block_addr_1 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_8_i
  %context_Message_Block_load_1 = load i8* %context_Message_Block_addr_1, align 1
  %tmp_11_i = or i6 %tmp_2_i, 2
  %tmp_12_i = zext i6 %tmp_11_i to i64
  %context_Message_Block_addr_2 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_12_i
  %context_Message_Block_load_2 = load i8* %context_Message_Block_addr_2, align 1
  %tmp_16_i = or i6 %tmp_2_i, 3
  %tmp_17_i = zext i6 %tmp_16_i to i64
  %context_Message_Block_addr_3 = getelementptr [64 x i8]* %context_Message_Block, i64 0, i64 %tmp_17_i
  %context_Message_Block_load_3 = load i8* %context_Message_Block_addr_3, align 1
  %tmp_19_i = call i32 @_ssdm_op_BitConcatenate.i32.i8.i8.i8.i8(i8 %context_Message_Block_load, i8 %context_Message_Block_load_1, i8 %context_Message_Block_load_2, i8 %context_Message_Block_load_3)
  store i32 %tmp_19_i, i32* %W_addr, align 4
  br label %0
